...
function dentroFoco(){
    ...
    <form enctype="multipart/form-data" class="form" action="clientes-salva.php"  method="POST" >
...
<input class="form_file" type="file" id="archivo" name="archivo">
    ...
    <br>
    <br> <a href="../Front/home.php" class="form_link">Regresar</a>
