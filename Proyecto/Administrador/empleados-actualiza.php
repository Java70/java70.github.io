...
?>
 ...
 while($row = $res->fetch_array()){
    ...
    <form enctype="multipart/form-data" class="form" action="empleados-update.php"  method="POST"   onsubmit="return validar();">
   ...
   <div class="alerta" id="mensaje"></div>
    ...
    <input type="hidden" name="pass" id="pass" class="form_input"  placeholder=" " value="<?php echo $pass =$row['password']?>">
    
    <input class="form_file" type="hidden" id="archivo" name="archivo" value="<?php echo $archivo =$row['archivo']?>">
   <div class="form_group">
...
<input class="form_file" type="file" id="archivo" name="archivo" value="<?php echo $archivo =$row['archivo']?>">
    ...
    <select class="form_select" name="rol" id="rol">
        <option value="0" <?php if ($rol == 0) echo " selected"; ?> >Empleado</option>
